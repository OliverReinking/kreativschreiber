...
<template>
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-layout-200">
            <div>
            ...
            <div class="mt-6 text-layout-500">
        ...
        <div class="bg-layout-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg text-layout-600 leading-7 font-semibold">
                        <a href="https://laravel.com/docs">Documentation</a>
                    </div>
                </div>

                <div class="ml-12">
                    <div class="mt-2 text-sm text-layout-500">
            ...
            <div class="p-6 border-t border-layout-200 md:border-t-0 md:border-l">
                <div class="flex items-center">
                    <svg
                        fill="none"
                        stroke="currentColor"
            ...
            <div class="p-6 border-t border-layout-200">
                <div class="flex items-center">
                    <svg
                        fill="none"
                        stroke="currentColor"
            ...
            <div class="p-6 border-t border-layout-200 md:border-l">
                <div class="flex items-center">
                    <svg
                        fill="none"
                        stroke="currentColor"
