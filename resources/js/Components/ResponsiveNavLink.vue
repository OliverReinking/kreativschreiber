...
const classes = computed(() => {
    return props.active
        ...
        : 'block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-layout-600 hover:text-layout-800 hover:bg-layout-50 hover:border-layout-300 focus:outline-none focus:text-layout-800 focus:bg-layout-50 focus:border-layout-300 transition';
});
</script>
