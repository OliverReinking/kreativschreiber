...
<template>
    ...
    <JetAuthenticationCard>
        ...
        <div class="mb-4 text-sm text-layout-600">
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-end mt-4">
                <button type="button" class="text-sm text-layout-600 hover:text-layout-900 underline cursor-pointer" @click.prevent="toggleRecovery">
                    <template v-if="! recovery">
