...
<template>
    <JetActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg font-medium text-layout-900 dark:text-white">
                {{ $t('You have enabled two factor authentication.') }}
            </h3>

            <h3 v-else-if="confirming" class="text-lg font-medium text-layout-900 dark:text-white">
                {{ $t('Finish enabling two factor authentication.') }}
            </h3>

            <h3 v-else class="text-lg font-medium text-layout-900 dark:text-white">
                {{ $t('You have not enabled two factor authentication.') }}
            </h3>

            <div class="mt-3 max-w-xl text-sm text-layout-600 dark:text-white">
                <p>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-layout-600 dark:text-white">
                    ...
                    <div class="mt-4 max-w-xl text-sm text-layout-600 dark:text-white" v-if="setupKey">
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    ...
                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-layout-100 rounded-lg">
