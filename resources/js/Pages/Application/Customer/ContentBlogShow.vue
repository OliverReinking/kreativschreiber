  ...
  <customer-layout>
    <template #breadcrumb>
      <breadcrumb
        ...
        current="Anzeige des Blogtextes"
        :breadcrumbs="{
    ...
    <!-- Anzeige Text -->
    <display-row label="Text erstellt am">
      <template #content>
        <display-date :value="content.creation_date" :time-on="true" />
      </template>
    </display-row>

    <display-row label="Eingaben">
      <template #content>
        <span v-html="content.prompt" class="text-lg"></span>
      </template>
    </display-row>

    <display-row label="Blogtext">
      <template #content>
        <copy-to-clipboard
          :copy-text="content.content"
          copy-description="Klicke hier und der Blogtext wird in die Zwischenablage kopiert"
        ></copy-to-clipboard>
      </template>
    </display-row>
